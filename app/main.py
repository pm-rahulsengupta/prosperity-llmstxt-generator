...
async def _brief_form(request: Request, session, domain: str, user, *, capped: str = ""):
    ...
    return templates.TemplateResponse(
        ...
        "brief.html",
        {
            ...
            "gsc_credential_configured": settings.gsc_credential_configured,
            "gsc_direct_read": settings.gsc_direct_read,
            "suggested": [],
            "reasoning": "",
            "llm_used": False,
            "dropped": [],
...
def _assemble(
    ...
    bundle = build_bundle(
        ...
        md_layout=md.layout,
        ai_info=info.html,
        ai_info_issues=info.copy_issues,
...
async def _delivery_report(session: AsyncSession, domain: str, view) -> DeliveryReport | None:
    ...
    return check_delivery(
        ...
        copy_issues=view.bundle.copy_issues,
