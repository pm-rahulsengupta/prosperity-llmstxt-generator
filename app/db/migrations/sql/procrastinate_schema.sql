-- Verbatim schema from procrastinate 3.9.0, captured at migration time.
-- Pinned as a file rather than called at runtime so a later procrastinate
-- upgrade cannot silently change what this migration does on a fresh database.
